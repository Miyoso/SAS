...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (method === 'GET') {
      const missions = await pool.query('SELECT * FROM missions ORDER BY start_time ASC');

      // Pour chaque mission, on récupère le roster et le matériel
    ...
    if (method === 'POST') {
      ...
      // --- ACTION : CHANGER LE STATUT (Kanban Move) ---
